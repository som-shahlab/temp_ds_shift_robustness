...
DATA_PATH="/local-scratch/nigam/projects/lguo/temp_ds_shift_robustness/dg/features/admissions"
...
python -m prediction_utils.extraction_utils.extract_features \
    --data_path="/local-scratch/nigam/projects/lguo/temp_ds_shift_robustness/dg/features/admissions_admission" \
...
python -m prediction_utils.extraction_utils.extract_features \
    --data_path="/local-scratch/nigam/projects/lguo/temp_ds_shift_robustness/dg/features/admissions_discharge" \
    --features_by_analysis_path="features_by_analysis" \
    --dataset=$DATASET \
    --rs_dataset=$RS_DATASET \
    --cohort_name=$COHORT_NAME \
