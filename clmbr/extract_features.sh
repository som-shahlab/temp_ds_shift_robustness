...
COHORT_NAME="clmbr_admission_rollup_filtered"
DATA_PATH="/local-scratch/nigam/projects/lguo/temp_ds_shift_robustness/clmbr/features/admissions"
...
python -m prediction_utils.extraction_utils.extract_features \
    --data_path="/local-scratch/nigam/projects/lguo/temp_ds_shift_robustness/clmbr/features/admissions_admission_midnight" \
    ...
    --index_date_field="admit_date_midnight" \
...
python -m prediction_utils.extraction_utils.extract_features \
    --data_path="/local-scratch/nigam/projects/lguo/temp_ds_shift_robustness/clmbr/features/admissions_discharge_midnight" \
    --features_by_analysis_path="features_by_analysis" \
    --dataset=$DATASET \
    --rs_dataset=$RS_DATASET \
    --cohort_name=$COHORT_NAME \
    ...
    --features_dataset=$FEATURES_DATASET \
    --features_prefix=$FEATURES_PREFIX \
    --index_date_field="discharge_date_midnight" \
    --row_id_field=$ROW_ID_FIELD \
    --merged_name=$MERGED_NAME \
    --exclude_analysis_ids "note_nlp" "note_nlp_dt" "note_nlp_delayed" \
    --time_bins "-36500" "-30" "-7" "0" \
